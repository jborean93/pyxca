...
{
    [DllImport("/home/jborean/dev/xpress/libxpress.so")]
...
$compressSize = 0
$decompressSize = 0
[Compression]::CompressWorkSpaceSizeXpressHuff([ref]$compressSize, [ref]$decompressSize)
...
try {
    ...
    $bufferUsed = 0
    try {
        [Runtime.InteropServices.Marshal]::Copy($data, 4, $fromBuffer, $data.Length - 4)
