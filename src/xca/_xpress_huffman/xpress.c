...
**==============================================================================
**
** Copyright (c) Microsoft Corporation. All rights reserved. See file LICENSE_MS
...

{
    ...
    {
        Workspace->RadixPass1Sorted[Workspace->RadixBuckets[Node->Frequency & 0xff]++] = (USHORT)Node->Symbol;
    }
...

{
    ...
    for (;;)
    {
        ...
        for (;;)
        {
            ...
            if (InputPos[5] != Match[5])
            {
                ...
                ExHashValue = (_rotl8((InputPos[4] ^ _rotr8(InputPos[0], 1)) - 187, 3) + _rotr8(InputPos[1] ^ _rotl8(InputPos[3], 3), 1)) * HASH_COEFF_HIGH + (InputPos[2] ^ _rotl8(InputPos[0], InputPos[4])) * HASH_COEFF_LOW;
    ...
    SafeDone:
        ...
        *TagsOut = RunningTags;
        ...
        BlockByteSize = (BlockBitSize + 31) / 32 * 4 + NonHuffmanBytes + 2 + sizeof(Workspace->Huffman.CompactBitLengths);
