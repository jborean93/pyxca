...
def example_xpress() -> None:
    ...
    compressed = base64.b16decode(
        "".upper()
    )

    xpress = xca.XpressHuffman()
    actual = xpress.decompress(compressed, 300)
...
def _unpack_message(
    ...
    rpid: typing.Optional[str] = str(uuid.UUID(bytes_le=bytes(data[8:24]))).upper()
    pid: typing.Optional[str] = str(uuid.UUID(bytes_le=bytes(data[24:40]))).upper()
...
for resp in responses:
    ...
    decompressed_data = xpress.decompress(data[4 : from_size + 4], to_size)
